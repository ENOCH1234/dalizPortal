...
<head>
	...
	<title>e-Portal Daliz School | Staff Login</title>
	<!-- google font -->
            ...
            <div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
					...
					<div class="container-login100-form-btn">
                        <button class="login100-form-btn" name="teacher_log">
							Login
						</button>
					</div>
					<div class="text-center p-t-30">
                        ...
                        <a href="./">
                            <button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-pink">
                                Student Login
                            </button>
                        </a>
                    </div>
                    <!-- <td>
						<button type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-primary" data-type="dialog3">CLICK ME</button>
                    </td> -->
				</form>
			</div>
		</div>
