...
<head>
	...
	<title>e-Portal Daliz School | Student Login</title>
	<!-- google font -->
            ...
            <div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter Registration Number">
						<input class="input100" type="text" name="reg" placeholder="Registration Number">
					...
					<div class="container-login100-form-btn">
                        <button class="login100-form-btn" name="stud_log">
							Login
						</button>
					</div>
