...
<head>
	...
	<title>e-Portal Daliz School | Add New Video</title>
	<!-- google font -->
			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add New Lecture Video</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href=dashboard>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Class Videos</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								...
								<div class="card-body row">
									...
									<div class="col-lg-12 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" name="title" id="txtPrice">
									...
									<div class="col-lg-12 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="vid_link">
									...
									<div class="col-lg-12 p-t-20 text-center">
										<button type="submit" name="upl_vid"
											class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink">Upload</button>
									</div>
								</div>
								</form>
							</div>
