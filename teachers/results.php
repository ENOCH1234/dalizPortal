...
<head>
	...
	<title>e-Portal Daliz School | All Uploaded Results</title>
	<!-- google font -->
			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Uploaded Results</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Uploaded Results</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="card card-box">
								<div class="card-head">
									<header>My Uploaded Results</header>
									<div class="tools">
										...
										<table
											...
											<tbody>
												<?php
													...
													$no = 1;
													$stmt = $DB_con->prepare("SELECT * from result_upl WHERE tutor_id='$user_id'");
													$stmt->execute();
												...
												<tr class="odd gradeX">
													...
													<td><?php if ($term == 1) echo 'First Term';
															if ($term == 2) echo 'Second Term';
															if ($term == 3) echo 'Third Term';
																	?></td>
