...
<head>
	...
	<title>e-Portal Daliz School | Add Subject</title>
	<!-- google font -->
							...
							<div class="card-box">
								...
								<div class="card-body row">
									...
									<div class="col-lg-12 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
											<input class="mdl-textfield__input" name="subject" type="text" id="list222" value=""
												tabIndex="-1" required>
									...
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield txt-full-width">
											<textarea class="mdl-textfield__input" name="description" rows="4" id="text7" required></textarea>
											<label class="mdl-textfield__label" for="text7">Short Description</label>
										</div>
									</div>
									<div class="col-lg-12 p-t-20 text-center">
										<button type="submit" name="add_sub"
