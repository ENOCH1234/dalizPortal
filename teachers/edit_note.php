...
<head>
	...
	<title>e-Portal Daliz School | Edit Note</title>
	<!-- google font -->
			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit Lecture Note</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="./">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><i class="fa fa-book"></i>&nbsp;<a class="parent-item" href="#">Class Notes</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="notes">All Uploaded Notes</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">Edit New Note</li>
							</ol>
						</div>
					</div>
					<div class="row">
								...
								<div class="card-body row">
									...
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield txt-full-width">
											<textarea class="mdl-textfield__input" name="topic" rows="4" id="text7" required><?php echo $topic?></textarea>
											<label class="mdl-textfield__label" for="text7">Topic</label>
										</div>
									</div>
									<div class="col-md-12 col-sm-12">
										<textarea name="note" id="formsummernote" cols="30" rows="10" required>
											<?php echo $note?>
										</textarea>
									</div>
									<input type="hidden" name="get_id" value="<?php echo $get_id ?>">
									<div class="col-lg-12 p-t-20 text-center">
										<button type="submit" name="upd_note"
