...
<head>
	...
	<title>e-Portal Daliz School | All Teachers</title>
	<!-- google font -->
...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-indigo">
			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">All Daliz Teachers</div>
							</div>
															...
															<table
																...
																<tbody>
																	<?php
																		...
																		$no = 1;
																		$stmt = $DB_con->prepare("SELECT * from tutor");
																		$stmt->execute();
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo "../profile-images/$profile_image"?>"
																				alt="">
																		</td>
																		...
																		<td class="left"><?php echo $yearjoined ?></td>
																		<td class="left"><?php echo $phone ?></td>
																		<td>
																			<?php echo"<a href='edit_teacher?id=$id'
																				class='btn btn-primary btn-xs' title='Edit Teacher'>"?>
	...
	<script>
	  function del(id){
		  //alert(id);
		  $('#btn_del'+id).load("functions/del_teacher.php", {
			  like_id:id 
		  }
		  )
