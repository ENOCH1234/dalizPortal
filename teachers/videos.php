...
<head>
	...
	<title>e-Portal Daliz School | All Uploaded Videos</title>
	<!-- google font -->
			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">All Uploaded Videos</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="./">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Lecture Videos</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">All Uploaded Videos</li>
							</ol>
						</div>
					</div>
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>My Uploaded Videos</header>
														<div class="tools">
															...
															<table
																...
																<tbody>
																	<?php
																		...
																		$no = 1;
																		$stmt = $DB_con->prepare("SELECT * from videos WHERE tutor_id='$user_id'");
																		$stmt->execute();
																	...
																	<tr class="odd gradeX">
																		...
																		<td>
																			<?php echo"<a href='edit_video?id=$id'
																				class='btn btn-primary btn-xs' title='Edit Video'>"?>
