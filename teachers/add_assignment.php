...
<head>
	...
	<title>e-Portal Daliz School | Add New Assignment</title>
	<!-- google font -->
			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add New Assignment</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li class="active">Add New Assignment</li>
							</ol>
						</div>
					</div>
					<div class="row">
							...
							<div class="card-box">
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
											<input class="mdl-textfield__input" name="topic" type="text" id="list22" value="" readonly
												tabIndex="-1" required>
											...
											<ul data-mdl-for="list22" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
												<?php
													$sql="SELECT DISTINCT `topic` FROM notes WHERE tutor_id='$user_id'";
													$result = mysqli_query($connect,$sql);
													while($row = mysqli_fetch_assoc($result)) {
														$topic = $row['topic'];
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" name="sub_date" id="date">
									...
									<div class="col-md-12 col-sm-12">
										<textarea name="assign_content" id="formsummernote" cols="30" rows="10" required>
											<h3 style="text-align: center;">
												<a href="#"	style="background-color: rgb(255, 255, 255); line-height: 1.428571429;">Put Assignment Content Here!</a>
											</h3>
										</textarea>
									</div>
									<?php
									...
									<div class="col-lg-12 p-t-20 text-center">
										<button type="submit" name="upl_as"
											class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink">Upload Assignment</button>
									</div>
								</div>
								</form>
							</div>
