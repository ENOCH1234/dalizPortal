...
<head>
	...
	<title>e-Portal Daliz School | All Uploaded Notes</title>
	<!-- google font -->
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-box">
								<div class="card-head">
									<header>My Uploaded Notes</header>
									<div class="tools">
										...
										<table
											...
											<tbody>
												<?php
													...
													$no = 1;
													$stmt = $DB_con->prepare("SELECT * from notes WHERE tutor_id='$user_id'");
													$stmt->execute();
