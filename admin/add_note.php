...
<head>
	...
	<title>e-Portal Daliz School | Add New Note</title>
	<!-- google font -->
			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add New Lecture Note</div>
							</div>
								...
								<div class="card-body row">
											...
											<ul data-mdl-for="list222" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
												<?php
													...
													while($row = mysqli_fetch_assoc($result)) {
														$id = $row['id'];
														$name = $row['name'];
														echo "<li class='mdl-menu__item' data-val='$id'>$id - $name</li>";
													} ?>
											</ul>
										</div>
									</div>
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield txt-full-width">
											<textarea class="mdl-textfield__input" name="topic" rows="4" id="text7" required></textarea>
									...
									<div class="col-md-12 col-sm-12">
										<textarea name="note" id="formsummernote" cols="30" rows="10" required>
											<h3 style="text-align: center;">
												<a href="#"	style="background-color: rgb(255, 255, 255); line-height: 1.428571429;">Put Course Content Here!</a>
											</h3>
										</textarea>
									</div>
									<?php
