...
<head>
	...
	<title>e-Portal Daliz School | Edit Teacher</title>
	<!-- google font -->
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><i class="fa fa-users"></i>&nbsp;<a class="parent-item" href="#">Teachers</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="teachers">All Teachers</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
							...
							<div class="card-box">
								...
								<form method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
									<?php
										...
										$query = ("SELECT * FROM tutor WHERE id='$get_id'");
									...
									<div class="card-body row">
										<div class="col-lg-12 p-t-20">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" name="name" type="text" value="<?php echo $name; ?>"
													tabIndex="-1" required>
										...
										<div class="col-lg-6 p-t-20">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
												<input class="mdl-textfield__input" name="gender" type="text" id="list222" value="<?php echo $gender; ?>" readonly
													tabIndex="-1" required>
										...
										<div class="col-lg-6 p-t-20">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" name="dob" id="date" type="text" value="<?php echo $dob; ?>"
													tabIndex="-1" required>
										...
										<div class="col-lg-6 p-t-20">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" name="phone" type="text" value="<?php echo $phone; ?>"
													tabIndex="-1" required>
										...
										<div class="col-lg-6 p-t-20">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" name="yearjoined" id="date" type="text" value="<?php echo $yearjoined; ?>"
													tabIndex="-1" required>
										...
										<!-- <div class="col-lg-6 p-t-20">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" name="username" type="text" value="<?php echo $username; ?>"
													tabIndex="-1" required>
										...
										<div class="col-lg-12 p-t-20 text-center">
											<button type="submit" name="upd_teacher"
												class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink">Update Teacher</button>
										</div>
