...
<head>
	...
	<title>e-Portal Daliz School | Edit Video</title>
	<!-- google font -->
			...
			<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit Lecture Video</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href=dashboard>Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><i class="fa fa-video"></i>&nbsp;<a class="parent-item" href="#">Lecture Videos</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="videos">All Uploaded Videos</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<?php
									$query = ("SELECT * FROM videos WHERE id='$get_id'");
								...
								<div class="card-body row">
									...
									<div class="col-lg-12 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" name="title" value="<?php echo $title; ?>" id="txtPrice">
											<label class="mdl-textfield__label">Video Title</label>
										</div>
									</div>
									<div class="col-lg-12 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" value="<?php echo $vid_link; ?>" name="vid_link">
											<label class="mdl-textfield__label">Video Link</label>
										</div>
									</div>
									<input type="hidden" name="get_id" value="<?php echo $get_id ?>">
									<div class="col-lg-12 p-t-20 text-center">
										<button type="submit" name="upd_vid"
