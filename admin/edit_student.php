...
<head>
	...
	<title>e-Portal Daliz School | Edit Student</title>
	<!-- google font -->
							...
							<div class="card-box">
								...
								<form method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
									<?php
										...
										$query = ("SELECT * FROM student WHERE id='$get_id'");
									...
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" name="reg" type="text" value="<?php echo $reg; ?>"
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" name="surname" type="text" value="<?php echo $surname; ?>"
												tabIndex="-1" required>
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" name="othernames" type="text" value="<?php echo $othernames; ?>"
												tabIndex="-1" required>
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">											
											<input class="mdl-textfield__input" name="guardian" type="text" value="<?php echo $guardian; ?>"
												tabIndex="-1" required>
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">											
											<input class="mdl-textfield__input" name="phone" type="phone" value="<?php echo $phone; ?>"
												tabIndex="-1" required>
											<label class="mdl-textfield__label">Guardian Phone Number</label>
										</div>
									</div>
									<div class="col-lg-12 p-t-20 text-center">
										<button type="submit" name="upd_student"
											class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink">Update Student</button>
									</div>
								</div>
