...
<head>
	...
	<title>e-Portal Daliz School | My Notes :: <?php echo $get_sub; ?></title>
	<!-- google font -->
			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="row">
						<div class="card-box">
							<div class="card-head">
								<header>All Notes for <?php echo $get_sub; ?></header>
							</div>
							<div class="card-body ">
								<!-- start course list -->
								<div class="row">
									<?php
										...
										$stmt = $DB_con->prepare("SELECT * from notes WHERE subject='$get_sub' AND class='$class' ORDER BY id DESC");
										$stmt->execute();
