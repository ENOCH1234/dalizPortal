				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 col-12">
							<div class="analysis-box m-b-0 bg-purple">
								<h3 class="text-white box-title">Notes By Me <span class="pull-right"><i
											class="fa fa-caret-up"></i> <?php
											$sql2 = "SELECT * FROM notes WHERE tutor_id='$user_id'";
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-12">
							<div class="analysis-box m-b-0 bg-danger">
								<h3 class="text-white box-title">My Videos <span class="pull-right"><i
											class="fa fa-caret-up"></i> <?php
											$sql2 = "SELECT * FROM videos WHERE tutor_id='$user_id'";
											$result2 = $connect->query($sql2);
											if ($result2->num_rows >= 0) {
												$rows1 = ($result2->num_rows);
												echo $rows1;
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-12">
							<div class="analysis-box m-b-0 bg-blue">
								<h3 class="text-white box-title">Assignments <span class="pull-right"><i
											class="fa fa-caret-up"></i><?php
											$sql2 = "SELECT * FROM assignments WHERE tutor_id='$user_id'";
											$result2 = $connect->query($sql2);
											if ($result2->num_rows >= 0) {
												$rows1 = ($result2->num_rows);
												echo $rows1;
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-12">
							<div class="analysis-box m-b-0 bg-success">
								<h3 class="text-white box-title">Term Results <span class="pull-right"><i
											class="fa fa-caret-up"></i> <?php
											$sql2 = "SELECT * FROM result_upl WHERE tutor_id='$user_id'";
											$result2 = $connect->query($sql2);
											if ($result2->num_rows >= 0) {
												$rows1 = ($result2->num_rows);
												echo $rows1;
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card  card-box">
								<div class="card-head">
									<header>Notes Uploaded By Me</header>
									<div class="tools">
										<a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a>
										<a class="t-collapse btn-color fa fa-chevron-down" href="javascript:;"></a>
										<a class="t-close btn-color fa fa-times" href="javascript:;"></a>
											...
											<table class="table display product-overview mb-30">
												...
												<tbody>
													<?php
														...
														$no = 1;
														$stmt = $DB_con->prepare("SELECT * from notes WHERE tutor_id='$user_id' ORDER BY id DESC");
														$stmt->execute();
													...
													<tr class="odd gradeX">
														...
														<td>
															<?php echo"<a href='edit_note?id=$id'
